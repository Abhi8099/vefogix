          ...
          <ul className="flex items-center gap-2 2xsm:gap-4">
            ...
            <div className='flex gap-2'>
              <Popover title="Balance" >
                <p className='flex items-center justify-center md:px-3 px-1 bg-[#00d27a] text-black rounded-full text-sm font-semibold md:py-1 hover:scale-110 transition-all ease-in-out duration-300'>$ {data && data.buyer_wallet.remain_balance}</p>
              </Popover>
              <Popover title="Reserved" >
                <p className='flex items-center justify-center md:px-3 px-1 bg-[#27bcfd] text-black rounded-full text-sm font-semibold md:py-1 hover:scale-110 transition-all ease-in-out duration-300'>$ {data && data.buyer_wallet.reserved_balance}</p>
              </Popover>
              <Popover title="Bonus" >
                <p className='flex items-center justify-center md:px-3 px-1 bg-[#ffdb4a] text-black rounded-full text-sm font-semibold md:py-1 hover:scale-110 transition-all ease-in-out duration-300'>$ {data && data.buyer_wallet.bonus_balance}</p>
              </Popover>
            </div>
