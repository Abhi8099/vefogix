...
import { RiArrowDownSLine, RiToolsLine, RiWallet3Fill } from "react-icons/ri";
...
const s_u_m = sumOfInProgressTask + sumOfNotStartedTask + sumOfImprovementTask
// console.log(s_u_m);
...
<FaTasks className="text-xl"/>
        ...
        label: 
            `Guest Post Tasks (${s_u_m})`,
        route: "/publisher-guestpost-tasks",
      },
      {
        icon: (
<SiPlatformdotsh className="text-xl"/>
  ...
  },
  {
    ...
    menuItems: [
      ...
      //   route: "",
      //   children: [
      //     { label: "Port Your Doc", route: `https://portyourdoc.com/` },
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-screen  flex-col overflow-y-hidden border-r border-stroke w-65 bg-[#122031] dark:border-stroke-dark dark:bg-gray-dark lg:static lg:translate-x-0 ${sidebarOpen
      ...
      {isOpen && (
        <>
<div className=" my-2 w-full rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-10">
          <div className="py-1">
            <a
              target="_blank"
              href="https://portyourdoc.com/"
              className="text-gray-700 dark:text-gray-300 flex items-center gap-3 px-4 py-2 text-base  font-medium hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <RiToolsLine className="text-lg" />
              Port Your Doc
            </a>
          </div>
        </div>
