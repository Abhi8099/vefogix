...
const fetchWebsites = async () => {
    ...
    try {
        const response = await axios.get(`${BASE_URL}favourite-sites/?status=True`, {
            headers: {
...
const columns = [
    {
        ...
        key: 'website',
        ...getColumnSearchProps('published_sites'),
...
<h1 className='text-center text-lg md:text-xl font-bold'>Websites in your Favourite list ({websitesSum})</h1>
<p className='text-center  '>Use this Favourite list to keep a list of websites handy and send them tasks as and when you feel the need.</p>
        </div>
